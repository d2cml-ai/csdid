...
_Suite: `csdid/test_csdid` · 564 collected · **564 passed**, 0 skipped, 0 failures._

## How many tests use R reference values?

**65 of the 564 passing tests (~12%) compare csdid output directly against
...
| test_review_fixes.py | 31 | csdid R-sync (review) | Regression | round-1/2 fixes, factor covariates, `allow_unbalanced_panel=False`, idname-numeric (+nullable Int64), universal-base NaN (position-based), `'post'` key alias |
